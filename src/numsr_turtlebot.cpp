...
public:
    ...
    dxl_sdk_wrapper{std::make_shared<DynamixelSDKWrapper>(opencr)}
  {
    ...
    subscriber = create_subscription<nuturtlebot_msgs::msg::WheelCommands>(
      "wheel_cmd", 10, std::bind(
        &NuTurtlebot::wheel_cmd_callback, this,
        _1));
    publisher = create_publisher<nuturtlebot_msgs::msg::SensorData>("sensor_data", 10);
    sound_srv = create_service<turtlebot3_msgs::srv::Sound>(
      "sound",
  ...
  void sound_callback(
    std::shared_ptr<turtlebot3_msgs::srv::Sound::Request> req,
